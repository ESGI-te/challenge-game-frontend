...
<template>
    <Wrapper>
        <Form @submit.prevent="onSubmit" @keydown.enter="$event.preventDefault()">
            ...
            <Select :options="themeOptions" :optionValue="id" :optionText="text" name="theme" label="Theme" />
        ...
        <v-btn @click="onSubmit" :disabled="!meta.dirty || !meta.valid" size="large" variant="elevated">Create</v-btn>
    </Wrapper>
</template>
